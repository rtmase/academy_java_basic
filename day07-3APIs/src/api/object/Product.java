...
//	// product 와 객체 들은 prodCode 가 같으면 동일 객체로 판단
//	@Override
//	public boolean equals(Object obj) {
//		// 1. 동일 비교 결과 저장 변수 선언
//		// 2. 초기화 : 기본 false 설정
...
//			// (2) 비교 하려하는 this 객체와 비교 대상인 obj 간 각각의 필드가 동일한지 비교
...
//		// 2. 비교하려는 필드가 기본형이면 참조형으로 바꾸는 포장 클래스 객체로 변환 후 hashCode() 를 호출
//		// 3. 1 과 2의 결과를 모두 ^(XOR) 연산을 통과시킨다.
//		
